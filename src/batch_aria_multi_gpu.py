...
INPUT_DIR = PROJECT_ROOT / "../data/AriaAEA/AEA_CROP_5fps" # AEA_CROP, AEA_CROP_10fps

DATA_CAPTURE_TYPE = None
OUTPUT_ROOT = PROJECT_ROOT / "../data/AriaAEA/output2"
COMMON_PRIVACY_PREFERENCE_FILE = "common_privacy_preference_0.json"
SAM_CONFIDENCE = 0.75
IMG_SIZE = 392 #[14, 28, 42, 56, 70, 84, 98, 112, 126, 140, 154, 168, 182, 196, 210, 224, 238, 252, 266, 280, 294, 308, 322, 336, 350, 364, 378, 392]
